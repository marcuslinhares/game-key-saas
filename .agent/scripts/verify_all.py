...
VERIFICATION_SUITE = [
    # P0: Security (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("Dependency Analysis", ".agent/skills/vulnerability-scanner/scripts/dependency_analyzer.py", True),
        ]
    },
    ...
    # P1: Code Quality (CRITICAL)
    {
        ...
        "checks": [
            ...
            ("Type Coverage", ".agent/skills/lint-and-validate/scripts/type_coverage.py", True),
        ]
    },
    ...
    # P4: UX & Accessibility
    {
        ...
        "checks": [
            ...
            ("Accessibility Check", ".agent/skills/frontend-design/scripts/accessibility_checker.py", True),
        ]
    },
    ...
    # P5: SEO & Content
    {
        ...
        "checks": [
            ...
            ("GEO Check", ".agent/skills/geo-fundamentals/scripts/geo_checker.py", True),
        ]
    },
    ...
    # P6: Performance (requires URL)
    {
        ...
        "checks": [
            ...
            ("Bundle Analysis", ".agent/skills/performance-profiling/scripts/bundle_analyzer.py", True),
        ]
    },
    ...
    # P8: Mobile (if applicable)
    {
        "category": "Mobile",
        "checks": [
            ("Mobile Audit", ".agent/skills/mobile-design/scripts/mobile_audit.py", True),
        ]
    },
    ...
    # P9: Internationalization
    {
        ...
        "checks": [
            ("i18n Check", ".agent/skills/i18n-localization/scripts/i18n_checker.py", True),
        ]
    },
]
...
def run_script(name: str, script_path: Path, project_path: str, url: Optional[str] = None) -> dict:
    ...
    if "test_runner" in script_path.name.lower():
        cmd.append("--coverage")
    ...
    try:
        result = subprocess.run(
            ...
            capture_output=True,
            text=True,
            timeout=1200  # 20 minute timeout para E2E e builds pesados
        )
...
Examples:
  ...
  python3 scripts/verify_all.py . --url https://staging.example.com --no-e2e
    ...
    parser.add_argument("--url", required=False, help="URL for performance & E2E checks")
